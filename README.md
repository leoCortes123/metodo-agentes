# developTool — Plan de completación de Quipu Enterprise

Este repositorio documenta el análisis y el plan para convertir **QUIPU_ENTERPRISE**
(`/mnt/datos/Programacion/QUIPU_ENTERPRISE`) en una herramienta completa de desarrollo
dirigido por agentes de IA, con destino comercial SaaS y primer caso real: absorber el
desarrollo de `chasqui_n8n`.

**Nada de esto modifica todavía el repositorio de Quipu**: es diseño e investigación.
...
| 2 | [`02-plan-fases.md`](02-plan-fases.md) | El plan detallado por fases, priorizado para absorber Chasqui cuanto antes |
...
| — | [`sistema-a/`](../QUIPU_ENTERPRISE/sistema-a/INDICE.md) | **Paquete ejecutable del Sistema A** (completar Quipu): AGENTS.md, CONSTITUCION, ESCALAMIENTO, VALIDACION, HANDOFF, PLAN/F0 + 6 tareas atómicas. Ya montado en `QUIPU_ENTERPRISE/sistema-a/`, con repositorio git propio. F0 y F1 cerradas |
